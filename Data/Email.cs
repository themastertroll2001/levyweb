...
namespace Barberia.Data
{
    public class Email
    {
        ...
        void Correo(string correo_receptor, string token)
        {
            ...
            email.Subject = "Barberia Levy Validación de Cuenta";
            email.Body = "Para activar su cuenta, haga clic en el siguiente enlace: https://barberialevygt.com/Cuenta/Token?valor=" + token;
